...
<body>
    ...
    <aside class="sidebar-modern" id="sidebar">
        ...
        <div class="nav-section">
            ...
            <a href="{{ route('dashboard.create') }}" class="nav-link-modern {{ request()->routeIs('dashboard.create') ? 'active' : '' }}">
                <i class="fas fa-user-plus"></i>
                <span>Add Customer</span>
            </a>
            <a href="{{ route('dashboard.index') }}" class="nav-link-modern {{ request()->routeIs('dashboard.index') ? 'active' : '' }}">
                <i class="fas fa-users"></i>
                <span>Customer List</span>
            </a>
            <a href="{{ route('dashboard.documents') }}" class="nav-link-modern {{ request()->routeIs('dashboard.documents') ? 'active' : '' }}">
    ...
    @if(Request::routeIs('dashboard'))
        ...
        <div class="quick-actions-grid">
            <a href="{{ route('dashboard.create') }}" class="quick-action-btn">
                <i class="fas fa-user-plus"></i>
                <div class="quick-action-label">Add Customer</div>
            </a>
            <a href="{{ route('dashboard.index') }}" class="quick-action-btn">
                <i class="fas fa-list"></i>
                <div class="quick-action-label">View All Customers</div>
            </a>
    ...
    @yield('content')
        ...
        <footer class="dashboard-footer">
            <p>© 2025 Admin Dashboard v2.0 | Last login: {{ now()->format('M d, Y - h:i A') }}</p>
        </footer>
    </main>
