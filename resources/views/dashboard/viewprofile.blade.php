        ...
        <div class="profile-header">
            <div class="profile-avatar">
                ...
                <div class="customer-id">
                    ID: CUST-{{ str_pad($customer->id, 6, '0', STR_PAD_LEFT) }}
                </div>
            </div>
            ...
            <p class="text-center mb-0" style="opacity: 0.9; font-size: 16px;">
                <i class="fas fa-user-tag me-2"></i>My Customer Account
            </p>
        </div>
        ...
        <div class="profile-info">
            ...
            <div class="stats-section">
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ $customer->created_at->diffInDays(now()) }}</div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ $customer->created_at->format('M','d','Y') }}</div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">My Location</div>
                </div>
            </div>
            ...
            <div class="info-section">
                <div class="section-header">
                    ...
                    <h2 class="section-title">My Basic Information</h2>
                </div>
            ...
            <div class="info-section">
                <div class="section-header">
                    ...
                    <h2 class="section-title">My Address Information</h2>
                </div>
            ...
            <div class="info-section">
                ...
                <a href="{{ route('dashboard.editdetails', $customer->id) }}" class="btn-modern btn-primary-modern">
                    <i class="fas fa-edit"></i> Edit My Profile
                </a>
                
                <a href="{{ route('dashboard.customerdetails') }}" class="btn-modern btn-secondary-modern">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const daysActiveElement = document.querySelectorAll('.stat-number')[0];
